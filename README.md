...
<body>
    ...
    <script>
        ...
        function resetGame() {
            ...
            spawnFood();
            updateUI();
            draw(); // This is safe now because snake is populated above
        }
        ...
        // FIXED: Instead of calling draw() immediately, call resetGame()
        // This populates the snake array so draw() doesn't crash.
        resetGame();
